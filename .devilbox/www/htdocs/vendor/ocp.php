        ...
        if (!empty($path)) {
            ...
            foreach ($dirs as $dir) {
                ...
                if (!isset($result[$dir])) {
                    ...
                    $result = isset($result[$dir]['children']) ? $result[$dir]['children'] : array();
                }
            }
        }
    ...
    <table class="doctable pivot">
        ...
        <tbody>
            <tr>
                <th>Host</th>
                <td><?php
                foreach (array('SERVER_NAME', 'HTTP_HOST', 'SERVER_ADDR', 'HOSTNAME') as $hostVar) {
            ...
            <tr>
                <th>JIT</th>
                <td><?php echo ($status['jit']['enabled'] && $status['jit']['on']) ? 'Enabled' : 'Disabled' ?></td>
            </tr>
        <?php endif; ?>
...
<section>
    ...
    <?php if (isset($status['jit'])): ?>
    <h2 id="jit" class="title">JIT</h2>
    <div class="table-overflow">
    <table class="doctable pivot">
        <caption>Raw JIT</caption>
        <col style="width: 50%" />
        <col />
        <tbody>
        <?php foreach ($status['jit'] as $title => $value): ?>
            <tr>
                <th><?php echo $this->escapeHtml($title) ?></th>
                <td><?php echo $this->escapeHtml($value) ?></td>
            </tr>
...
<section>
    ...
    <table class="doctable">
        ...
        <?php foreach ($ini as $directive => $info): ?>
            <tr>
                ...
                ?>
                <td><a href="https://www.php.net/manual/en/opcache.configuration.php#ini.<?php echo $directiveFragment ?>"><?php echo $this->escapeHtml($directive) ?></a></td>
    ...
    <?php foreach ($functions as $func): ?>
        <li><a href="https://www.php.net/manual/en/function.<?php echo str_replace('_', '-', $func) ?>.php"><?php echo $func ?></a></li>
    <?php endforeach; ?>
    </ul>
    ...
    <table class="doctable">
        ...
        <tbody>
            <tr<?php if (!($opLevel & 1)): ?> class="disabled"<?php endif; ?>>
                ...
                <td>
                    <ul>
                        ...
                        <li>Optimize series of <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.add-char.php">ADD_CHAR</a>/<a href="http://php.adamharvey.name/manual/en/internals2.opcodes.add-string.php">ADD_STRING</a></li>
                        <li>Convert <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.cast.php">CAST</a>(IS_BOOL,x) into <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.bool.php">BOOL</a>(x)
                        <li>Convert <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.init-fcall-by-name.php">INIT_FCALL_BY_NAME</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.do-fcall-by-name.php">DO_FCALL_BY_NAME</a> into <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.do-fcall.php">DO_FCALL</a></li>
                    </ul>
                </td>
            </tr>
            <tr<?php if (!($opLevel & 1 << 1)): ?> class="disabled"<?php endif; ?>>
                ...
                <td>
                    <ul>
                        ...
                        <li>Optimize constant conditional jumps (<a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpz-ex.php">JMPZ_EX</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpnz-ex.php">JPMNZ_EX</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpz.php">JMPZ</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpnz.php">JMPNZ</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpznz.php">JMPZNZ</a>)</li>
                        <li>Optimize static <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.brk.php">BRK</a>s and <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.cont.php">CONT</a>s</li>
                    </ul>
                </td>
            </tr>
            <tr<?php if (!($opLevel & 1 << 2)): ?> class="disabled"<?php endif; ?>>
                ...
                <td>
                    <ul>
                        ...
                        <li>Optimize series of jumps (<a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmp.php">JMP</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpz-ex.php">JMPZ_EX</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpnz-ex.php">JPMNZ_EX</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpz.php">JMPZ</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpnz.php">JMPNZ</a>, <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.jmpznz.php">JMPZNZ</a>)</li>
                    </ul>
                </td>
            </tr>
            <tr class="disabled">
            ...
            <tr<?php if (!($opLevel & 1)): ?> class="disabled"<?php endif; ?>>
                <td>10</td>
                <td>Remove <a href="http://php.adamharvey.name/manual/en/internals2.opcodes.nop.php">NOP</a>s</td>
            </tr>
        </tbody>
    </table>
    </div>
...
<footer>
    <div class="container footer-content">
        <div class="row-fluid">
        <ul class="footmenu">
            <li><a href="https://www.php.net/manual/en/book.opcache.php">PHP Manual</a></li>
            <li><a href="https://www.php.net/manual/en/opcache.configuration.php">Configuration</a></li>
        <li><a href="https://www.php.net/manual/en/ref.opcache.php">Functions</a></li>
